...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2016 at 12:38 AM
...
INSERT INTO `item` (`ItemID`, `ItemCategoryID`, `ItemName`, `ItemDesc`, `ItemPrice`, `ItemImage`, `ItemLastUpdate`, `stock`) VALUES
(1, 1, 'Chilli Peppa Surfboard', 'Enjoy a little piece of Chilli! A small wave surfboard that features clear colour. Fins included. This board has paddle power and stability for all levels of surfing. Suits beginner to advanced.', '850.00', 'product_01.jpg', '2015-10-19 05:48:07', 3),
(2, 1, 'Supa Fish Pro Surfboard', 'A hybrid surfboard constructed from the latest material and delivers unrivalled performance in the water. Features a clear coating. Fins not included. The moderate curve out the tail keeps the board responsive when driving off your boot foot. Suits beginner to advanced.', '920.00', 'product_02.jpg', '2015-10-19 05:52:48', 8),
(3, 1, 'Catch Surf Odysea Surfboard', 'A high performance surfboard with durable graphic slick bottom. White acrylic spray construction. Versatile for surfers who want to take their good wave performance to the next level. Suits beginner to intermediate.', '395.00', 'product_03.jpg', '2015-10-19 05:52:48', 2),
(4, 1, 'DHD Stab in the Dark Surfboard', 'Stab invited the best shapers in the world to create this surfboard. The moment you stand on it you will feel the quality. It is the ultimate surfboard. Features clear colour and optional fins. Suits beginner to advanced.', '860.00', 'product_04.jpg', '2015-10-19 05:53:41', 1),
(5, 2, 'Billabong Revolution Sport 2MM Wetsuit', 'Mens long sleeve black wetsuit. Back zip entry. Made from 80% nylon and 20% elastane. 2mm thickness.', '290.00', 'product_05.jpg', '2015-10-19 05:53:41', 2),
(6, 2, 'Quicksilver Modern Originals 2MM Wetsuit', 'Mens short sleeve blue/black wetsuit. Zipperless entry with shoulder strap. Made from 92% nylon/polyamide and 8% elastane. 2mm thickness.', '180.00', 'product_06.jpg', '2015-10-19 05:55:01', 7),
(7, 3, 'Captain Fin Co. Boardshort', 'Mens above the knee black boardshort. Tie at waist. Made from 100% polyester with a fitted waistband. Zip pocket on outside hem of right leg.', '69.95', 'product_07.jpg', '2015-10-19 05:55:01', 3),
(8, 3, 'Minkpink Moroccan Holiday Bikini', 'Ladies multi-coloured bikini. Made from 80 polyamide and 20% elastane. All-over Moroccan inspired print. Adjustable and removable straps included.', '90.00', 'product_08.jpg', '2015-10-19 05:56:16', 8),
(9, 4, 'Pendleton Oversized Beach Towel', 'A luxurious soft oversized beach towel. Summer inspired multi-coloured design. Made from 100% cotton. Looped on one side for superior absorption.', '99.95', 'product_09.jpg', '2015-10-19 05:56:16', 1),
(10, 4, 'Ray-Ban Aviator Sunglasses', 'Stylish aviator sunglasses in arista brown. Featuring a metal frame and stainless steel hinges with 100% UV protection. Case included.', '210.00', 'product_10.jpg', '2015-10-19 05:56:45', 1);
...
ALTER TABLE `invoice`
  ...
  ADD KEY `InvoiceCustomerID` (`InvoiceCustomerID`);
...
ALTER TABLE `invoice_item`
  ...
  ADD KEY `InvItemInvoiceID` (`InvItemInvoiceID`),
  ADD KEY `invoice_item_ibfk_2` (`InvItemItemID`);
